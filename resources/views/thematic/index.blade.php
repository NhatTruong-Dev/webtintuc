                    ...
                    <div class="card-body">
                        @can('them-chuyen-de')
                            <a href="{{ url('/thematic/create') }}" class="btn btn-success btn-sm" title="Add New Contact">
                                <i class="fa fa-plus" aria-hidden="true"></i> Create Thematic
                            </a>
                        @endcan
                        <br/>
                        <br/>
                                ...
                                @foreach($thematics as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/thematic/' . $item->id) }}" title="View "><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> </button></a>
                                            @can('sua-chuyen-de')
