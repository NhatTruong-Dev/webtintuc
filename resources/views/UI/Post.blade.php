        ...
        <div class="container paddding">
            ...
            <div class="container-fluid pb-4 pt-5">
                <div class="container animate-box">
                    <div>
                        <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Bài viết khác</div>
                    </div>
                    <div class="owl-carousel owl-theme" id="slider2" style="display: flex">
                    ...
                    <div class="row" >
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group fl_icon">
                                ...
                                <input class="form-input" name="name" type="text" placeholder="Họ tên" style="font-size:19px">
                            </div>
                        </div>
                        <br>
                        <div class="col-xs-12 col-sm-6 fl_icon">
                            <div class="form-group fl_icon">
                                ...
                                <input class="form-input" type="text" name="email " placeholder="Email" style="font-size:19px">
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="form-group">
                                <textarea class="form-input" name="contentt" required="" placeholder="Nội dung bình luận ..." style="font-size:19px;margin-left:15px" cols="50"></textarea>
                            </div>
                        </div>
