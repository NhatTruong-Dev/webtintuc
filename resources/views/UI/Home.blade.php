...
@section('content')
        ...
        <div class="row mx-0">
            <div class="col-md-6 col-12 paddding " data-animate-effect="fadeIn">
                <div class="fh5co_suceefh5co_height"><img src="{{ asset($postTop->image ) }}" alt="img"
                    ...
                    <div style="z-index:3;position: relative;margin-top:10px"><span class="badge badge-secondary"
                                                                                    style="color: white;background-color: #1c7430;margin-left:20px;margin-bottom:20px;padding:5px;font-size:14px">{{$postTop->category->name}}</span>
                    </div>
                        ...
                        <div class="col-md-6 col-6 paddding " data-animate-effect="fadeIn">
                            @if(count($category->post))
                                <div class="fh5co_suceefh5co_height_2"><img src="{{$category->post->first()->image}}"
                                                                            alt="img" style="position: absolute"/>
                                    <div style="z-index:3;position: relative;margin-top:10px"><span
                                            class="badge badge-secondary"
                                            style="color: white;background-color: #17A2B8;margin-left:20px;margin-bottom:20px;padding:10px;font-size:13px">{{$category->name}}</span>
                                    </div>
    ...
    <div class="chuyende"
         style="height:50px;width:1250px;margin-left:190px;margin-bottom:80px;font-family: Arial, Verdana, sans-serif">
                ...
                @foreach($thematics as $thematic)
                    <li>
                        <div class="buttons" style="margin-right:-10px;margin-top:-25px;">
                            <button class="btn-hover color-1" style="padding-left:25px"># <a class="text-dark"
                                                                                             href="{{url('UI/Thematic/'.$thematic->id)}}"
            ...
            <div class="row mx-0">
                        ...
                        <div class="row pb-4">
                            <div class="col-md-5">
                                <div class="fh5co_hover_news_img">
                                    <div class="fh5co_news_img"><img src="{{asset($item->image)}}" alt=""/></div>
                                    <div></div>
                                </div>
                            </div>
                ...
                <div class="col-md-3 " data-animate-effect="fadeInRight">
                    ...
                    <div style="text-align: center;width:300px;margin-top:30px">
                        ...
                        <div class="elfsight-app-3ef635c7-32e7-48cf-ab43-c96f2455e5da"></div>
                    </div>
                    ...
                    @foreach($postViews as $postView)
                        <div class="row pb-3">
                            <div class="col-5 align-self-center">
                                <img src="{{asset($postView->image)}}" alt="imgsrc" class="fh5co_most_trading"/>
                            </div>
    ...
    <div style="text-align: center"><h1>Podcast</h1>
        <script src="https://apps.elfsight.com/p/platform.js" defer></script>
        <div class="elfsight-app-f5121808-2de1-467a-8c79-9ae439aa060f"></div>
    </div>
